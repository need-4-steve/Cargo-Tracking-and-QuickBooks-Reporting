...
$result = mysqli_query($link, "SELECT * FROM ItemInventoryAssemblyLine WHERE TimeCreated>{ts '2017-01-01 00:00:00.000'} and TimeCreated<= {ts '2017-02-01 00:00:00.000'}");
