...
$query = "SELECT Name, barcode, carrier, timestamp FROM `barcodestireside` WHERE barcode LIKE '$tracking'
UNION 
SELECT Name, barcode, carrier, timestamp FROM `barcodespartside` WHERE barcode LIKE '$tracking' ORDER BY timestamp";
