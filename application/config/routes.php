...
$route['Ajax/save_state/(:any)/(:any)'] = 'Ajax/save_state/$1/$2';
$route['Ajax/load_state/(:any)'] = 'Ajax/load_state/$1';
$route['users'] = 'users/login';
$route['calendar'] = 'calendar';
$route['users/register'] = 'users/register';
$route['richfilemanager'] = 'richfilemanager';
$route['Shipments/check_for_eta_updates'] = 'Shipments/check_for_eta_updates';
$route['Shipments/fix_inconsistencies'] = 'Shipments/fix_inconsistencies';
$route['Shipments/check_for_email_documents'] = 'Shipments/check_for_email_documents';
$route['Shipments/get_cn_data/(:any)'] = 'Shipments/get_cn_data/$1';
$route['Shipments/get_lfd_and_pickup_number_from_bol/(:any)'] = 'Shipments/get_lfd_and_pickup_number_from_bol/$1';
