...
$sSQL = "SELECT * from ItemInventoryAssemblyLine WHERE TimeModified >= {ts '2014-01-01 00:00:00.000'}";
   ...
   foreach($row as $key => $value) {
	...
	if( mysqli_num_rows($result) > 0) {
		   ...
		   if($resUpdate)
			...
			{
			print("UPDATE ItemInventoryAssemblyLine SET " . implode(", ", $keysValue) . "  WHERE $pare1;");
