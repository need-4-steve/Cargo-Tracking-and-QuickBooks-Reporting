<html>
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4-4.0.0/jq-3.2.1/moment-2.18.1/jszip-2.5.0/pdfmake-0.1.32/dt-1.10.16/af-2.2.2/b-1.5.1/b-colvis-1.5.1/b-flash-1.5.1/b-html5-1.5.1/b-print-1.5.1/cr-1.4.1/fc-3.2.4/fh-3.1.3/kt-2.3.2/r-2.2.1/rg-1.0.2/rr-1.2.3/sc-1.4.4/sl-1.2.5/datatables.min.css">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <?php if(!$this->session->userdata('logged_in')) : ?>
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="userspace" aria-expanded="false">User Space <span class="caret"></span></a>
                                ...
                                <?php endif; ?>
                                <?php if($this->session->userdata('logged_in')) : ?>
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="userspace" aria-expanded="false"><?php echo $this->session->userdata('username'); ?><span class="caret"></span></a>
                                        <div class="dropdown-menu" aria-labelledby="userspace">
                                            ...
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="<?php echo base_url(); ?>">Calendar</a>
                                            <div class="dropdown-divider"></div>
                ...
                <div class="page-header" id="banner">
                    <div class="row">
                        <div class="col-lg-8 col-md-7 col-sm-6">
                            ...
                            <!--<p class="lead">Libra Cargo Management</p> -->
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-5 col-sm-6">
                            ...
                            <?php if($this->session->flashdata('post_deleted')): ?>
                                <div class="alert alert-dismissible alert-warning">
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                    <p class="alert alert-warning"><?php echo $this->session->flashdata('post_deleted'); ?></p>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($this->session->flashdata('user_loggedin')): ?>
                                <div class="alert alert-dismissible alert-primary">
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                    <p class="alert alert-primary"><?php echo $this->session->flashdata('user_loggedin'); ?></p>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($this->session->flashdata('user_loggedout')): ?>
                                <div class="alert alert-dismissible alert-primary">
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                    <p class="alert alert-primary"><?php echo $this->session->flashdata('user_loggedout'); ?></p>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($this->session->flashdata('category_deleted')): ?>
                                <div class="alert alert-dismissible alert-warning">
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                    <p class="alert alert-warning"><?php echo $this->session->flashdata('category_deleted'); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
