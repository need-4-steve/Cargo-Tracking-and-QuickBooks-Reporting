...
$route['Shipments/testobl/(:any)'] = 'Shipments/get_lfd_and_pickup_number_from_bol/$1';
$route['Ajax/Shipments'] = 'Ajax/Shipments';
$route['users'] = 'users/login';
$route['calendar'] = 'calendar';
$route['users/register'] = 'users/register';
$route['filemanager'] = 'filemanager/index';
$route['filemanager/index'] = 'filemanager/index';
$route['filemanager/folder'] = 'filemanager/folder';
$route['filemanager/uploadfiles'] = 'filemanager/uploadfiles';
$route['file/deleteFile'] = 'filemanager/deleteFile';
$route['file/renameFile'] = 'filemanager/renameFile';
$route['file/createFolder'] = 'filemanager/createFolder';
$route['file/deleteFolder'] = 'filemanager/deleteFolder';
$route['file/renameFolder'] = 'filemanager/renameFolder';
